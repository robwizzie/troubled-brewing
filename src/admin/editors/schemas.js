...
export const SECTION_EDITOR_SCHEMAS = {
  ...
  immersive_gallery_hero: {
    fields: [
      ...
      {
        name: 'igh_real_art',
        label: 'Show your photos in the frames',
        type: 'checkbox',
        hint: 'On: your own photos hang in the painted frames on the scene, covering the artwork it was drawn with. Off: the room shows exactly as painted. Leave this on — the pictures on your wall should be yours.',
      },
      { name: 'ticker_items', label: 'Ticker strip items', type: 'tags', hint: 'The scrolling marquee under the hero — comma separated.' },
      {
        name: 'igh_pieces',
        ...
        hint: 'Every framed picture on your homepage — its photo, its label, where it goes and its frame. The photo hangs inside that frame on the scene, and is the picture phone visitors see. Leave a box blank to keep the original.',
      },
    ],
  },
